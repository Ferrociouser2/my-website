<?php
    ...
    $botToken  = '6846832959:AAEwVoUCTGJzfwIABbQAUdoM2d7UmAebzfg';// your tg token bot from botfather (dont put "bot" infront it)
	$chat_id  = ['5185303227'];// your tg userid from userinfobot
